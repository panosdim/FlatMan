...
fun RentsScreen() {
    ...
    val isLoading = flatsResponse is Response.Loading || rentsResponse is Response.Loading
    ...
    when (rentsResponse) {
        ...
        is Response.Error -> {
            Toast.makeText(
                context,
                (rentsResponse as Response.Error).errorMessage,
                Toast.LENGTH_SHORT
            )
                .show()
        }
    ...
    if (isLoading) {
        ...
        Column(
            ...
            Row(
                ...
                SmallFloatingActionButton(onClick = { scope.launch { addTransactionSheetState.show() } }) {
                    Icon(
                        Icons.Outlined.Add,
